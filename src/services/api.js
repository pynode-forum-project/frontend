...
export const userAPI = {
  ...
  updateProfileImage: (id, profileImageUrl) =>
    api.put(`/users/${id}/profile-image`, { profileImageUrl }),
...
export const replyAPI = {
  ...
  create: (postId, comment, attachments = []) =>
    api.post(`/posts/${postId}/replies`, { comment, attachments }),
  createSubReply: (
    replyId,
    comment,
    attachments = [],
  ...
  deleteNested: (parentReplyId, targetPath) =>
    api.delete(`/replies/${parentReplyId}/nested`, { data: { targetPath } }),
};
...
export const historyAPI = {
  ...
  getUserHistory: (userId, params = {}) =>
    api.get(`/users/${userId}/history`, { params }),
  search: (userId, params = {}) =>
    api.get(`/users/${userId}/history/search`, { params }),
};
